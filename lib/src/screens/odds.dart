              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    ...
                    itemCount: controller.selectedCatDataOdds.value.length,
                    itemBuilder: (cntx, ind){
                    return MatchCard(height: height, width: width, data: controller.selectedCatDataOdds.value[ind], controlle: controller, oddsScreen: true,);
                    }),)
                    )
                ],
              ),
